...
contract PlayerBook {
    ...
    TeamJustInterface constant private TeamJust = TeamJustInterface(0x692a70d2e424a56d2c6c27aa97d1a86395877b3a);
...
//==============================================================================    
        ...
        public
    {
        ...
        plyr_[1].addr = 0x0000000000000000000000000000000000000000;
        plyr_[1].name = "name1";
        plyr_[1].names = 1;
        pIDxAddr_[0x0000000000000000000000000000000000000000] = 1;
        pIDxName_["name1"] = 1;
        plyrNames_[1]["name1"] = true;
        plyrNameList_[1][1] = "name1";
        
        plyr_[2].addr = 0x0000000000000000000000000000000000000000;
        plyr_[2].name = "name2";
        plyr_[2].names = 1;
        pIDxAddr_[0x0000000000000000000000000000000000000000] = 2;
        pIDxName_["name2"] = 2;
        plyrNames_[2]["name2"] = true;
        plyrNameList_[2][1] = "name2";
        
        plyr_[3].addr = 0x0000000000000000000000000000000000000000;
        plyr_[3].name = "name3";
        plyr_[3].names = 1;
        pIDxAddr_[0x0000000000000000000000000000000000000000] = 3;
        pIDxName_["name3"] = 3;
        plyrNames_[3]["name3"] = true;
        plyrNameList_[3][1] = "name3";
        
        plyr_[4].addr = 0x0000000000000000000000000000000000000000;
        plyr_[4].name = "name4";
        plyr_[4].names = 1;
        pIDxAddr_[0x0000000000000000000000000000000000000000] = 4;
        pIDxName_["name4"] = 4;
        plyrNames_[4]["name4"] = true;
        plyrNameList_[4][1] = "name4";
