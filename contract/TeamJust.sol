...
contract TeamJust {
    ...
    {
        admin = msg.sender;
        address name1       = 0x0000000000000000000000000000000000000000;
        address name2       = 0x0000000000000000000000000000000000000000;
        address name3       = 0x0000000000000000000000000000000000000000;
        address name4       = 0x0000000000000000000000000000000000000000;
        
        admins_[name1]      = Admin(true, true, "name1");
        admins_[name2]      = Admin(true, true, "name2");
        admins_[name3]      = Admin(true, true, "name3");
        admins_[name4]      = Admin(true, true, "name4");
